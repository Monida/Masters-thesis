...
for a=1:axs
    ...
    plot(t,MeanRHipRef(:,a,1),'Color','k','Linewidth',2) 
    plot(t,MeanRHipRef(:,a,2),'Color','k')
    plot(t,MeanRHipRef(:,a,3),'Color','k')
    plot(t,MeanRHipOC(:,a,1),'Color',gray,'Linewidth',2,'Linestyle','--') 
    plot(t,MeanRHipOC(:,a,2),'Color',gray)
    plot(t,MeanRHipOC(:,a,3),'Color',gray)
    plot(t,MeanRHipCorr(:,a,1),'Color',gray,'Linewidth',2,'Linestyle','.') 
    plot(t,MeanRHipCorr(:,a,2),'Color',gray)
    plot(t,MeanRHipCorr(:,a,3),'Color',gray)
...
for a=1:axs
    ...
    plot(t,MeanRKneeRef(:,a,1),'Color','k','Linewidth',2) 
    plot(t,MeanRKneeRef(:,a,2),'Color','k')
    plot(t,MeanRKneeRef(:,a,3),'Color','k')
    plot(t,MeanRKneeOC(:,a,1),'Color',gray,'Linewidth',2,'Linestyle','--') 
    plot(t,MeanRKneeOC(:,a,2),'Color',gray)
    plot(t,MeanRKneeOC(:,a,3),'Color',gray)
    plot(t,MeanRKneeCorr(:,a,1),'Color',gray,'Linewidth',2,'Linestyle','.') 
    plot(t,MeanRKneeCorr(:,a,2),'Color',gray)
    plot(t,MeanRKneeCorr(:,a,3),'Color',gray)
...
for a=1:axs
    ...
    plot(t,MeanRAnkleRef(:,a,1),'Color','k','Linewidth',2) 
    plot(t,MeanRAnkleRef(:,a,2),'Color','k')
    plot(t,MeanRAnkleRef(:,a,3),'Color','k')
    plot(t,MeanRAnkleOC(:,a,1),'Color',gray,'Linewidth',2,'Linestyle','--') 
    plot(t,MeanRAnkleOC(:,a,2),'Color',gray)
    plot(t,MeanRAnkleOC(:,a,3),'Color',gray)
    plot(t,MeanRAnkleCorr(:,a,1),'Color',gray,'Linewidth',2,'Linestyle','.') 
    plot(t,MeanRAnkleCorr(:,a,2),'Color',gray)
    plot(t,MeanRAnkleCorr(:,a,3),'Color',gray)
